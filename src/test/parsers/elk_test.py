...
class Test_cells0(unittest.TestCase):
    ...
    def test_cells(self):
        ...
        assert_standard_crystal_cell(c[-1])
...
class Test_bands0(unittest.TestCase):
    ...
    def test_bands(self):
        ...
        testing.assert_equal(b.values[:3, 0],
                             numpy.array((-2.729662146, -2.729661982, -2.729661566)) * numericalunits.Hartree)
        testing.assert_equal(b.values[-3:, -1],
                             numpy.array((0.8610216055, 0.8620398955, 0.8633321818)) * numericalunits.Hartree)
